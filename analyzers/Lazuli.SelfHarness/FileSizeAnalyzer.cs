...
namespace Lazuli.SelfHarness;

/// <summary>
/// LZSELF001 — keeps every Lazuli library source file at or under 500 lines, the same
...
public sealed class FileSizeAnalyzer : DiagnosticAnalyzer
{
    ...
    private static readonly DiagnosticDescriptor Rule = new(
        ...
        category: "Lazuli.SelfHarness",
        defaultSeverity: DiagnosticSeverity.Error,
        isEnabledByDefault: true,
        description: "Lazuli library files stay at or under the ceiling so each holds a single, readable concern.");
