...
///
/// The policy is a single dial (<c>[testing] criticality</c> in <c>Lazuli.toml</c>) projected to the
/// analyzers as the MSBuild property <c>LazuliCriticality</c> — the doctor's <c>buildTransitive</c> targets
...
internal static class CriticalityPolicy
{
    ...
    public const string OptionKey = "build_property.LazuliCriticality";
