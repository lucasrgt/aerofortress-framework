...
/// <summary>
/// AF0012 — a <c>[Slice]</c>'s <c>Map</c> must name its endpoint after the slice:
...
/// by construction. (A slice missing its <c>Map</c> entirely is AF0001's concern, not this rule's.)
/// </summary>
...
public sealed class EndpointNameAnalyzer : DiagnosticAnalyzer
{
    ...
    public const string DiagnosticId = "AF0012";
