...
| 0004 | lzfe-design-band      | LZFE024 `ui-door` · LZFE025 `scale-only` · LZFE026 `semantic-colors` — shipped, error-tier on the sample. Known blind spot: Tailwind utility classes (HIGH portback). |
...
| 0006 | design-skill          | `lazuli-design` — the pointer-only context loader (repo + template, byte-identical). |
...
- **LZFE026 Tailwind leg** — the harvest's HIGH finding: flag palette-family utility classes
