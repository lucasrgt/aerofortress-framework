...
export const FRONTEND_PACKAGE_VERSIONS = Object.freeze([
  Object.freeze({ name: "@aerofortress/frontend-sdk", version: "1.0.2" }),
  Object.freeze({ name: "@aerofortress/react", version: "1.0.2" }),
  Object.freeze({ name: "eslint-plugin-aerofortress", version: "1.0.2" }),
]);
