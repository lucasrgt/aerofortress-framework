...
///         services.UseIsolatedInMemory&lt;WalletsDb&gt;();   // from the optional Lazuli.Testing.InMemory package
/// }
/// </code>
/// </summary>
/// <typeparam name="TProgram">The application entry-point class the host boots (its <c>Program</c>).</typeparam>
public abstract class LazuliWebTest<TProgram> : WebApplicationFactory<TProgram>
    where TProgram : class
{
    ...
    ///
    /// <list type="bullet">
    /// <item><description>Fast and isolated — reference the <c>Lazuli.Testing.InMemory</c> package and
