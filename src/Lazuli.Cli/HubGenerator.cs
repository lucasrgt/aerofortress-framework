...
public static class HubGenerator
{
    ...
    private static void PrintWiring(string name)
    {
        ...
        Console.WriteLine(
            ...
            ride the query string. With Lazuli.Auth's JWT, add (using Microsoft.AspNetCore.Authentication.JwtBearer):
            ...
            Requires Lazuli.Auth (run `lazuli g auth` if you haven't). Scaling past one instance?
