...
/// inherit and nothing happens at runtime. Crucially it is <strong>not</strong> a discovery mechanism — AeroFortress
/// reflects over nothing; the registry is explicit code you can read. Remove the <c>AeroFortress.Framework.Doctor</c> analyzer
