...
public class CompositionRootAnalyzerTests
{
    ...
    private static string Program(string extra) => $$"""
        ...
        namespace Stubs
        {
            ...
            {
                public static IServiceCollection AddAeroFortress(this IServiceCollection s) => s;
                ...
                public static WebApplication UseAeroFortress(this WebApplication a) => a;
