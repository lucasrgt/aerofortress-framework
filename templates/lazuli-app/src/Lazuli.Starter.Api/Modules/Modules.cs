...
namespace Lazuli.Starter.Api.Modules;

/// <summary>The module registry — the one explicit list of the app's modules, wired on both sides: AddModules
/// registers each module's services, MapModules its routes. Adding a module is a line in each (lazuli g appends
/// them). Explicit on purpose — Lazuli discovers nothing by reflection; the doctor (LZ0016) checks every
